...
$(document).on('show.bs.modal','.modal',function(){$(document.body).addClass('modal-open')}).on('hidden.bs.modal','.modal',function(){$(document.body).removeClass('modal-open')})}(jQuery);function replaceHeader(content){jQuery(document).ready(function(){jQuery("#global-header > nav > .wrapper").replaceWith(content);jQuery("#global-header > nav > .wrapper").fadeIn(function(){jQuery(this).find("a[href*='"+ window.location.hostname+"']").addClass("current");if(typeof afterReplaceNav==='function'){afterReplaceNav();}});});}
